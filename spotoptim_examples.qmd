...
1. **Initial Design Phase**: `get_initial_design()`, `curate_initial_design()`, `rm_initial_design_NA_values()`, `check_size_initial_design()`, `get_best_xy_initial_design()`
...
### 2.3 `rm_initial_design_NA_values()`
