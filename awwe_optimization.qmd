...
## Method 1: SpotOptim (Bayesian Optimization)

```{python}
print("=" * 60)
print("Running SpotOptim (Bayesian Optimization)...")
print("=" * 60)
...
print("\n1. BEST SOLUTION:")
best_method = comparison.loc[1:, 'Best Weight (lb)'].idxmin() + 1
best_name = comparison.loc[best_method, 'Method']
best_weight = comparison.loc[best_method, 'Best Weight (lb)']
best_improvement = comparison.loc[best_method, 'Improvement (%)']
print(f"   Method: {best_name}")
print(f"   Wing Weight: {best_weight:.2f} lb")
print(f"   Improvement: {best_improvement:.2f}%")

print("\n2. METHOD CHARACTERISTICS:")
print("   - SpotOptim (Bayesian Optimization):")
print("     * Best for expensive black-box functions")
print("     * Efficient exploration-exploitation trade-off")
print("     * Provides uncertainty quantification")
print("     * Good for global optimization")
print("\n   - Nelder-Mead:")
print("     * Derivative-free, robust to noise")
print("     * Can be slow to converge")
print("     * May get stuck in local minima")
print("\n   - BFGS:")
print("     * Fast convergence for smooth functions")
print("     * Uses gradient approximations")
print("     * Good for local optimization")

print("\n3. KEY FINDINGS:")
print(f"   - All methods achieved significant weight reduction")
print(f"   - Baseline weight: {baseline_weight:.2f} lb")
print(f"   - Best optimized weight: {best_weight:.2f} lb")
print(f"   - Maximum improvement: {best_improvement:.2f}%")

print("\n4. DESIGN IMPLICATIONS:")
print("   - Primary weight drivers: Load factor (Nz), Wing area (Sw), Gross weight (Wdg)")
print("   - Optimization suggests reducing these parameters where feasible")
print("   - Consider trade-offs with performance requirements (stall speed, turn rate, etc.)")
