...
#### Robust Function Saving

SpotOptim uses `dill` for serialization, which allows robust saving of objective functions, including lambda functions and locally defined functions. This means you do **not** need to manually re-attach the 
objective function after loading a result file.
